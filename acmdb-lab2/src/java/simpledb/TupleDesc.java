...
public class TupleDesc implements Serializable {
    ...
    public TupleDesc(Type[] typeAr) {
        ...
        int len = typeAr.length;
        items = new ArrayList<>();
        for (Type type : typeAr) items.add(new TDItem(type, null));
    }
    ...
    public boolean equals(Object o) {
        ...
        if (((TupleDesc) o).numFields() != numFields()) return false;
        for (int i = 0; i < numFields(); i++)
            if (!((TupleDesc) o).getFieldType(i).equals(getFieldType(i))) return false;
        return true;
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < numFields(); i++)
            string.append(items.get(i).toString()).append("'");
